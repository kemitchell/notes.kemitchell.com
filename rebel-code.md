...
- threat of fragmentation (305)
- XEmacs fork promotes user choice (305)
- threat of concentration (306)
- Red Hat the new Microsoft? (306)
- FSF slow to approve Cygnus GCC work (306)
- EGCS fork (307)
- blessed by RMS (307)
- "Red Hat will never become another Microsoft." (308)
- MandrakeSoft: Red Hat + KDE (309)
- Mandrake-Macmillan publishing deal (309)
- Perens created Linux Standard Base (310)
- patent threat (311)
- de-commoditize (311)
- embrace, extend, extinguish (311)
- example: Win2k Kerberos (312)
- license for Kerberos extension doc prohibited implementation (312)
- Microsoft DMCA'd copy on Slashdot (312)
- Moglen on GPL enforceability (312)
- Larry McVoy: next problem is persistent revenue stream (313)
- McVoy: all user rights, no vendor rights (313)
- after the easy work, a grind (314)
- killing your supplier (314)
- afford to have ... engineers working on stuff ... don't understand ... agree with (315)
- do not code to live, live to code (315)
- hacker turnover (316)
- China averse to lock-in (317)
- FSF India (317)
- Simputer (318)
- Computer Programming for Everybody (319)
- Python named after Monty Python (319)
- Linux and GNU succession (321)
- Linux will be superseded. (322)
- harder to replace RMS than Linus (322)
- RMS: "I don't see who's going to replace me." (323)
- potentially de Icaza (323)
- freedom, sharing, community (323)
- "the code within" (323)

## Afterword
- VA Linux tanked (324)
- Ajuba acquihired (325)
- released TclPro (325)
- Eazel tanked (325)
- Nautilus released (325)
- SourceXchange closed (326)
- aborted Linuxcare-TurboLinux merger (326)
- era of hacker bosses ends (326)
- PHP v. ASP (327)
- VC convinced Zope to release (328)
- second-generation companies (328)
- IBM $1 billion (328)
- free software will thrive somewhere (329)
- .Net (329)
- Microsoft shifts to services (330)
- Microsoft changing attitude (330)
- "cancer" (331)
